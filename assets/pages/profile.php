...
global $user;
?>
<div class="card theme-dark container  mt-4 col-md-9 col-sm-11 rounded-0">
  <div class="col-12 rounded p-4 mt-4 d-md-flex gap-5">
    ...
    <div class="col-md-8 col-sm-11">
      <div class="theme-text-light d-flex flex-column">
        <div class="d-flex gap-5 align-items-center">
          ...
          <div class="dropdown">
            <span class="" style="font-size:xx-large" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
              <i class="theme-text-light bi bi-three-dots"></i>
            </span>
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              <li>
                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#chatbox" onclick="popchat(<?=$profile['id']?>)">
                  <i class="bi bi-chat-fill"></i> Message
                </a>
              </li>
              <li>
                <a class="dropdown-item " href="assets/php/actions.php?block=<?=$profile['id']?>&username=<?=$profile['username']?>">
        ...
        <div class="d-flex gap-2 align-items-center my-3">
          ...
          <a class="btn btn-sm btn-primary <?=count($profile['followers'])<1?'disabled':''?>" data-bs-toggle="modal" data-bs-target="#follower_list">
            <i class="bi bi-people-fill"></i><?=count($profile['followers'])?> Followers
          </a>
          <a class="btn btn-sm btn-primary <?=count($profile['following'])<1?'disabled':''?>" data-bs-toggle="modal" data-bs-target="#following_list">
          ...
          <div class="modal-content">
            <div class="modal-body d-md-flex p-0">
              ...
              <div class="col-md-4 col-sm-12 d-flex flex-column">
                ...
                <div>
                    <img src="assets/images/profile/<?=$profile['profile_pic']?>" alt="" height="50" width="50" class="rounded-circle border" />
                </div>
                <div>&nbsp;&nbsp;&nbsp;</div>
                <div class="d-flex flex-column justify-content-start">
                  <h6 style="margin: 0px;">
                   ...
                   <h6 style="margin:0px;" class="text-muted">@<?=$profile['username']?> </h6>
                </div>
                  <div class="d-flex flex-column align-items-end flex-fill">
                    ...
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        ?>
                          <li>
                            <a class="dropdown-item" href="?u=<?=$lu['username']?>">
                  ...
                  foreach($comments as $comment){
                    ...
                    <div class="d-flex align-items-center p-2">
                      ...
                      <div class="d-flex flex-column justify-content-start align-items-start">
                        <h6 style="margin: 0px;">
                          <a href="?u=<?=$cuser['username']?>" class="text-decoration-none text-muted">
                            @<?=$cuser['username']?>
                          </a> - <?=$comment['comment']?>
                        </h6>
                ...
                if(checkFollowStatus($profile['id']) || $profile['id']==$user['id']){
                  ...
                  <div class="input-group p-2 border-top">
                    ...
                    <button class="btn btn-outline-primary rounded-0 border-0 add-comment" data-cs="comment-section<?=$post['id']?>" data-post-id="<?=$post['id']?>" type="button" id="button-addon2">
                                    Post
                    </button>
                  </div>
                   <?php
