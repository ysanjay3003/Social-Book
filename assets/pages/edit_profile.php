...
<div class="container col-md-9 col-sm-12 rounded-0 d-flex justify-content-between">
  <div class="card col-12 theme-dark rounded p-4 mt-4 shadow-sm">
    <form method="post" action="assets/php/actions.php?updateprofile" enctype="multipart/form-data">
      <div class="d-flex justify-content-center"></div>
        <h1 class="theme-text-light h5 mb-3 fw-normal">Edit Profile</h1>
        <?php
        if(isset($_GET['success'])){
        ?>
        <h6 class="text-success">Profile is updated !</h6>
        <?php
        }
        ?>
      <div class="form-floating mt-1 col-md-6 col-sm-12">
        <img src="assets/images/profile/<?=$user['profile_pic']?>" class="border border-2 my-3" style="height:150px;width:150px" alt="..." />
        <div class="mb-3" >
      ...
      <?=showError('last_name')?>
      <div class="theme-text-light d-flex gap-3 my-3">
      ...
      <div class="form-floating mt-1">
         <input type="email" value="<?=$user['email']?>" class="theme-text-light form-control rounded-0" placeholder="email" disabled />
      ...
      <div class="mt-3 d-flex justify-content-between align-items-center">
                <button class="btn btn-primary text-decoration-none" type="submit">Update Profile</button>
      </div>
