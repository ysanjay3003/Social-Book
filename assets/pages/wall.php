...
<div class="container col-md-10 col-sm-12 col-lg-12 rounded-0 d-flex justify-content-between">
  <div class="col-md-8 col-sm-12 " style="max-width:93vw">
    ...
    if(count($posts)<1)
    {
       echo "<h6 style='width:100%' class='card p-2 theme-dark rounded text-center my-3 col-12'>Follow Someone or Add a new post </h6>";
    }
    foreach($posts as $post){
    $likes = getLikes($post['id']);
    $comments = getComments($post['id']);
    ?>
      <div class="theme-text-light theme-dark card shadow  mt-4">
        <!-------------POST div-->
        <div class="card-title d-flex justify-content-between  align-items-center">
          <div class="d-flex align-items-center p-2">
            <img src="assets/images/profile/<?=$post['profile_pic']?>" alt="" height="30" width="30" class="rounded-circle border" />&nbsp;&nbsp;
            <a href='?u=<?=$post['username']?>' class="text-decoration-none">
          ...
          <div class="p-2">
            ...
            ?>
            <div class="dropdown">
              <i class="bi bi-three-dots-vertical" id="option<?=$post['id']?>" data-bs-toggle="dropdown" aria-expanded="false">
              </i>
              <ul class="dropdown-menu" aria-labelledby="option<?=$post['id']?>">
                <li>
                  <a class="dropdown-item" href="assets/php/actions.php?deletepost=<?=$post['id']?>">
        ...
        <h4 style="font-size:x-larger" class="p-2 border-bottom d-flex">
          ...
          <i class="bi bi-chat-left d-flex align-items-center">
            <span class="p-1 mx-2 text-small" style="font-size:small" data-bs-toggle="modal" data-bs-target="#postview<?=$post['id']?>">
      ...
      <div class="d-flex modal-dialog modal-xl modal-dialog-centered">
        <div class="theme-dark modal-content">
          <div class="modal-body d-md-flex p-0">
            ...
            <div class=" theme-text-light col-md-4 col-sm-12 d-flex flex-column">
              <div class=" d-flex align-items-center p-2 border-bottom">
                ...
                <div class="d-flex flex-column justify-content-start">
                  ...
                  <h6 style="margin:0px;" class="text-muted">@<?=$post['username']?></h6>
                </div>
              ...
              <div class="flex-fill align-self-stretch overflow-auto" id="comment-section<?=$post['id']?>" style="height: 100px;">
                ...
                {
                ?>
                  <h6 class="p-3 text-center my-2 nce">no comments</h6>
                <?php
                }
                ...
                ?>
                  <div class="d-flex align-items-center p-2">
                    ...
                    <div class="d-flex flex-column justify-content-start align-items-start">
                      <h6 style="margin: 0px;">
                          <a href="?u=<?=$cuser['username']?>" class="text-decoration-none text-dark text-small text-muted">@<?=$cuser['username']?>
                          </a> - <?=$comment['comment']?>
                      </h6>
  ...
  <!---------------------Right sidebar------------------------>
  <div class="ms-4 col-lg-4 col-sm-0 overflow-hidden mt-2 p-sm-0 p-md-3">
    <div class="card theme-dark shadow p-2 mb-2 align-items-center p-2">
      <div>
          <img src="assets/images/profile/<?=$user['profile_pic']?>" alt="" height="60" width="60" class="rounded-circle border" />
      </div>
      <div class="d-flex flex-column justify-content-center">
        ...
        <a href='?u=<?=$user['username']?>'  style="margin:0px;" class="text-muted theme-text-light text-decoration-none">
               @<?=$user['username']?>
        </a>
      </div>
    </div>
    <div class="card theme-dark text-dark shadow p-2 btn-text">
      <h6 class="text-muted-50 p-2">You Can Follow Them</h6>
        <hr class="theme-text-light"/>
      <?php
        ...
        <div class="d-flex justify-content-between">
          <div class="d-flex align-items-center p-2">
            ...
            <div class="d-flex flex-column justify-content-center">
                ...
                <h6 style="margin:0px;font-size:small" class="text-muted">@<?=$suser['username']?></h6>
            </div>
          </div>
          <div class="d-flex align-items-center">
      ...
      if(count($follow_suggestions)<1)
        {
          echo "<p class='p-2 rounded'><h6 class='text-center'>No Suggestions For You</h6></p>";
        }
        ?>      
    </div>
      <!--<div class="card theme-dark my-2 text-dark shadow p-2 btn-text">
      </div>-->
  </div>
</div>
