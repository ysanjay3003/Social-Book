...
foreach($chats as $chat){
    ...
    <div class="d-flex justify-content-between border-bottom chatlist_item" data-bs-toggle="modal" data-bs-target="#chatbox" onclick="popchat('.$chat['user_id'].')" >
       <div class="d-flex align-items-center p-2">
           <div>
            <img src="assets/images/profile/'.$ch_user['profile_pic'].'" alt="" height="40" width="40" class="rounded-circle border">
           </div>
           <div>&nbsp;&nbsp;</div>
           <div class="d-flex flex-column justify-content-center" >
              ...
              <h6 style="margin:0px;font-size:small;" class="theme-text-light">'.$chat['messages'][0]['msg'].'</h6>
              <time style="font-size:small;" class="timeago text-small theme-text-light text-muted" datetime="'.$chat['messages'][0]['created_at'].'">'.gettime($chat['messages'][0]['created_at']).'</time>
           </div>
        </div>
        <div class="d-flex align-items-center">
            <div class="p-1 bg-primary rounded-circle '.($seen?'d-none':'').'">
            </div>
        </div>
    </div>';
                            ...
                            <div>
                             ...
                             <div class="d-flex flex-column justify-content-center">
                                 <a href="?u='.$fuser['username'].'" class="text-decoration-none text-dark">
                                  ...
                                  <h6 style="margin:0px;font-size:small;" class="theme-text-light text-muted">@'.$fuser['username'].'</h6>
                              </div>
                            </div>
                            <div class="d-flex align-items-center">
                              '.$fbtn.'
