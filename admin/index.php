...
<html lang="en">
  <head>
    ...
    <title>Socialbook | Dashboard</title>
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    ...
    <!-- Preloader -->
      <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="../assets/images/sb-icon.png" alt="AdminLTELogo" height="60" width="60">
      </div>
      ...
      <a href="" class="brand-link">
        <img src="../assets/images/sb-icon.png" alt="AdminLTE Logo" class="brand-image elevation-3">
        <span class="brand-text">Socialbook</span>
      </a>
                    ...
                    foreach($userslist as $user)
                    {
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex">
                            <div>
                              <img src="../assets/images/profile/<?=$user['profile_pic']?>" class="rounded-circle border border-2 shadow-sm mx-2" width="55" height="55" />
                            </div>
                            <div>
                        ...
                        <?php 
                        if($user['ac_status']==0): ?>
                            <button class="m-1 btn btn-warning btn-sm verify_user_btn" data-user-id="<?=$user['id']?>">Verify</button><?php endif; ?>
